...
CREATE TABLE FUNCIONARIOS (
    CODFUNCIONARIO INTEGER IDENTITY(1,1) PRIMARY KEY,
    NOMEFUNCIONARIO VARCHAR(100) NOT NULL,
    NUMEROCASA VARCHAR(10),
    CODRUA_FK INTEGER REFERENCES RUA(COD) ON DELETE CASCADE ON UPDATE CASCADE,
    CODBAIRRO_FK INTEGER REFERENCES BAIRRO(COD) ON DELETE CASCADE ON UPDATE CASCADE,
    CODCEP_FK INTEGER REFERENCES CEP(COD) ON DELETE CASCADE ON UPDATE CASCADE,
    CODCIDADE_FK INTEGER REFERENCES CIDADE(COD) ON DELETE CASCADE ON UPDATE CASCADE,
    CODFUNCAO_FK INTEGER REFERENCES FUNCAO(COD) ON DELETE CASCADE ON UPDATE CASCADE,
    SALARIO NUMERIC(10, 2) NOT NULL,
    CODLOJA_FK INTEGER REFERENCES LOJA(COD) ON DELETE CASCADE ON UPDATE CASCADE
);
